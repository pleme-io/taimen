...
> non-trivial changes. Video conferencing server (Zoom alternative); the
> WebRTC SFU and signaling surface are rendered from typed eizou/denshin
> primitives, paired with the optional GPU TUI client.
