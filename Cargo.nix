    ...
    crates = {
      ...
      "git+https://github.com/pleme-io/shikumi#0.1.0" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "69e983f54d36c4e2fb7def89c2e5c4525722483c";
          sha256 = "0jridislqn9ws9wrk8xy5ac235jpasvacg6jsf7yqd8hc4b3fddl";
        };
        dependencies = [
          {
            name = "arc-swap";
      ...
      "kaname" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          sha256 = "0vzjlz35npca5ks8v2574kn4kh59l9z8mn7v33rykhjx6ql8jfc9";
        };
        dependencies = [
          {
            name = "rmcp";
      ...
      "shidou" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "eec198f657a1789adff4d9bc9f11b535aca21d14";
          sha256 = "1mr30yg7h5cd7783nj75ly7vl0jj0zi58syzl975mrnjwmbm0m1b";
        };
        dependencies = [
          {
            name = "anyhow";
      ...
      "soushi" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "505500120a1161f2c477675cff33cde861bac969";
          sha256 = "0r2ywrr0nrn9zhjbmml02w3hny46s5nc438yly9yrbykiqx5fzbk";
        };
        dependencies = [
          {
            name = "rhai";
      ...
      "taimen" = rec {
        ...
        dependencies = [
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "rt-multi-thread" "net" "sync" "macros" "signal" "fs" ];
          }
          {
            name = "tower-http";
      ...
      "thin-vec" = rec {
        ...
        version = "0.2.18";
        edition = "2018";
        sha256 = "10ml7530igcr5xdnl21z6z07zihcnljgm0362k87s2lgnily5xxh";
        libName = "thin_vec";
        authors = [
      ...
      "tsunagu" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "e2c56778c4cb5218941fa1f5849dca0231470ed4";
          sha256 = "0a1qfl08ca6gllqkgb4lyjqrql3j3rif1dw1h3zp43is3nmajpin";
        };
        dependencies = [
          {
            name = "axum";
